...
The intended distribution is an LGPL-compatible FFmpeg build. Before distributing an installer or packaged application, confirm the exact binary source, FFmpeg license text, and any required source-code offer or URL for the chosen build.
